...
class Player:
    ...
    def __init__(self, name, start_location="Suomi"):
        ...
        print(f"Luodaan uusi pelaaja, pelaajia nyt {Player.player_count} kpl")
        self.name = name
        self.score = 0
        self.level = 1
...
# yleensä huono tapa muuttaa olion ominaisuuksia suoraan ulkopuolelta
#p2.score = 16
...
# Olioviittausten tallentaminen listaa muuttujien sijasta
players = []
...
# sijoitetaan viittaukset olemassa oleviin pelaajaolioihin listalle
players.append(p1)
players.append(p2)
players.append(p3)

# listan käsittely luupissa kuin ennenkint
for p in players:
    p.print_info()
    p.add_score()
print("-------")
