...
def calculate_numbers(calc_type, num1, num2):
    # print(f"{num1 + num2}")
    if calc_type == "add":
        # funktion suoritus loppuu heti, kun se palauttaa jotain
        return num1 + num2
...
# kaikki muuttujat viittaavat samaan listaan
print(inventory)

# esimerkki materiaalista primitiiviarvoilla
def vaihda(kaupunki):
    kaupunki = "Vantaa"
...
result = calc_v2(2, 4)
print(result)
# syötetään parametrit vapaajärjestyksessä nimeämällä ne
